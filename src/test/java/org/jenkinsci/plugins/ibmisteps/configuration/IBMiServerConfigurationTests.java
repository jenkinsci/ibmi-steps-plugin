...
public class IBMiServerConfigurationTests {
    ...
    public void testChecks() {
        ...
        final IBMiServerConfiguration validServer = new IBMiServerConfiguration("An IBMi server", "server.address", "1234567890", "0", false);
        assertEquals("host is mandatory", FormValidation.Kind.OK,
                serverDescriptor.doCheckHost(validServer.getHost()).kind);
        assertEquals("name is mandatory", FormValidation.Kind.OK,
                serverDescriptor.doCheckName(validServer.getName()).kind);
        ...
        assertEquals("host is mandatory", FormValidation.Kind.ERROR,
                serverDescriptor.doCheckHost(invalidServer.getHost()).kind);
        assertEquals("name is mandatory", FormValidation.Kind.ERROR,
                serverDescriptor.doCheckName(invalidServer.getName()).kind);
    ...
    public void testEquals() {
        final IBMiServerConfiguration server = new IBMiServerConfiguration("An IBMi server", "server.address", "1234567890", "37", true);
        final IBMiServerConfiguration serverEquals = new IBMiServerConfiguration("An IBMi server", "server.address", "1234567890", "37", true);
        final IBMiServerConfiguration serverNotEquals1 = new IBMiServerConfiguration("Another IBMi server", "server.address", "1234567890", "37",
                true);
        final IBMiServerConfiguration serverNotEquals2 = new IBMiServerConfiguration("An IBMi server", "server.address.else", "1234567890", "37",
                true);
        final IBMiServerConfiguration serverNotEquals3 = new IBMiServerConfiguration("An IBMi server", "server.address", "a6d5ecee", "37", true);
        final IBMiServerConfiguration serverNotEquals4 = new IBMiServerConfiguration("An IBMi server", "server.address", "1234567890", "5026",
                true);
        final IBMiServerConfiguration serverNotEquals5 = new IBMiServerConfiguration("An IBMi server", "server.address", "1234567890", "37",
                false);
